...
BACKGROUND = pygame.image.load('/home/anush/NEAT_FlappyBird/background.png')
...
class Bird(pygame.sprite.Sprite):
    ...
    def __init__(self,displayScreen):
        ...
        self.image = pygame.image.load('/home/anush/NEAT_FlappyBird/redbird.png')
...
class Pipe(pygame.sprite.Sprite):
	...
	def __init__(self,screen,x):
		...
		self.screen = screen
		self.lowerBlock = PipeBlock('/home/anush/NEAT_FlappyBird/pipe-red.png',False)
		self.upperBlock = PipeBlock('/home/anush/NEAT_FlappyBird/pipe-red.png',True)
...
def game(genome, config):
	...
	bird = Bird(DISPLAY)
	pipe1 = Pipe(DISPLAY, SCREENWIDTH+90)
	pipe2 = Pipe(DISPLAY, SCREENWIDTH+90+(SCREENWIDTH/2))
...
outputDir = '/home/anush/NEAT_FlappyBird/bestGenomes'
os.chdir(outputDir)
